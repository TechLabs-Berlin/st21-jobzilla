...
<tr>
    <td valign="top" colspan="2" style="color:#333333;padding-bottom:22px;">
        <?php echo dashboard_lang('_CHANGE_EMAIL_FIRST_LINE'); ?>
    </td>
</tr>

<tr>
   <td valign="top" colspan="2" style="color:#fff;text-align: center;font-size: 20px;">
         <a onMouseOver="this.style.backgroundColor='#36a3f7';"  onMouseOut="this.style.backgroundColor='#36a3f0';" style="font-family:Arial;background:#36a3f7;text-decoration:none !important;text-align:center;border: medium none;color:#ffffff !important;font-size: 20px;font-weight: 700;width: 100%;display:block;padding: 12px 0;"  target="_blank" href="<?php echo $url;?>"> <?php echo dashboard_lang('_CLICK_HERE_TO_CHANGE_EMAIL'); ?> </a>
    </td>
</tr>

<tr>
    <td valign="top" colspan="2" style="color:#333333; padding-top: 30px; padding-bottom:30px;">
        <?php echo dashboard_lang('_CHANGE_EMAIL_NOTES'); ?>
    </td>
</tr>
