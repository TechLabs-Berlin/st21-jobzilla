...
class Template
{
     ...
     * @access public
     * @param
     *            string array key to access template settings
     * @return void
     */
     ...
     * @access public
     * @param
     *            string filename of new master template file
     * @return void
     */
    ...
    {
        // Set master template
        if (isset($props['template']) && (file_exists(APPPATH . 'views/' . $props['template']) or file_exists(APPPATH . 'views/' . $props['template'] . '.php'))) {
     ...
     * @access public
     * @param
     *            array properly formed regions array
     * @return void
     */
     ...
     * @access public
     * @param
     *            string Name to identify the region
     * @param
     *            array Optional array with region defaults
     * @return void
     */
     ...
     * @access public
     * @param
     *            string name of parser class to load and use for parsing methods
     * @return void
     */
     ...
     * @access public
     * @param
     *            string name of parser class member function to call when parsing
     * @return void
     */
     ...
     * @access public
     * @param
     *            string region to write to
     * @param
     *            string what to write
     * @param
     *            boolean FALSE to append to region, TRUE to overwrite region
     * @return void
     */
            ...
            if ($overwrite === TRUE) // Should we append the content or overwrite it
{
    ...
    /**
     * Write content from a View to a region.
     * 'Views within views'
     *
     * @access public
     * @param
     ...
     *            string region to write to
     * @param
     *            string view file to parse
     * @param
     *            array  to pass into view for parsing
     * @param
     *            boolean FALSE to append to region, TRUE to overwrite region
     * @return void
     */
     ...
     * @access public
     * @param
     *            string script to import or embed
     * @param
     *            string 'import' to load external file or 'embed' to add as-is
     * @param
     *            boolean TRUE to use 'defer' attribute, FALSE to exclude it
     ...
     * @access public
     * @param
     *            string CSS file to link, import or embed
     * @param
     *            string 'link', 'import' or 'embed'
     * @param
     *            string media attribute to use with 'link' type only, FALSE for none
     * @return TRUE on success, FALSE otherwise
     */
     ...
     * @access public
     * @param
     *            string optionally opt to render a specific region
     * @param
     *            boolean FALSE to output the rendered template, TRUE to return as a string. Always TRUE when $region is supplied
        ...
        if ($region) // Display a specific regions contents
{
    ...
    /**
     * Build a region from it's contents.
     * Apply wrapper if provided
     *
     * @access private
     * @param
     *            string region to build
     * @param
     *            string HTML element to wrap regions in; like '<div>'
     * @param
     *            array Multidimensional array of HTML elements to apply to $wrapper
