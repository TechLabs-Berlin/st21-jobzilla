...
class Excel_gen
{
     ...
     *            Encoding to be used (defaults to UTF-8)
     * @param boolean $bConvertTypes
     *            Convert to field specification
     * @param string $sWorksheetTitle
     ...
     *
     * @param array $array
     *            One-dimensional array with row content
     */
    ...
    public function addArray($array)
    {
        ...
        $mergeArray = array_merge($fieldName, $array);
     ...
     *            Name of excel file to generate (...xls)
     */
