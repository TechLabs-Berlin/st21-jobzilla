<?php
    ...
    function renderbatchHistoryLineWithBreak ( $time, $msg ) {

       $traslatedMsg = replacebatcheFields($msg);
    ...
    function replacebatcheFields($message) {
        ...
        $message = str_replace("_BATCHES_CREATED_BY", dashboard_lang("_BATCHES_CREATED_BY"), $message);
