...
class Custom_b_form_helper
{
    ...
    static function render_field($xmlObject, $selected = '', $permissions, $id = 0, $form_orientation = "", $field_cols = "")
    {
         ...
         * render_{type_name}
         */
        if (method_exists('Custom_b_form_helper', $function_name)) {
    ...
    static function render_input($xmlObject, $selected, $extra, $field_status)
    {
        ...
        $prepend_extra_name = @$xmlObject['prepend_extra_name'];
        $invoice_contact = @$xmlObject['invoice_contact'];
        $tabindex = @$xmlObject['tabindex'];

        if( $invoice_contact == 1 ){
            $name = 'invoice_'.$name;
        }
    ...
    static function render_eav($xmlObject, $selected, $extra, $field_status)
    {
        ...
        // $output_html .= "<script> var ref_table_list_".$xmlObject['name']." = ".'"'.Custom_b_form_helper::render_ref_table_options($ref_table_name, $ref_key, $ref_value).'"'.";
        $output_html .= "<script> var ref_table_list_" . $xmlObject['name'] . " =  " . '"' . Custom_b_form_helper::render_ref_table_options($ref_table_name, $reference_key, $selected_value = 0, $ref_key, $ref_value, $ref_attribute, $ref_attribute_table_name, $ref_attribute_field_name) . '"' . ";
