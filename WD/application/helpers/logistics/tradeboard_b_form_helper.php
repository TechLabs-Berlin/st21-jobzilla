...
class Tradeboard_form_helper
{
    ...
    static function render_number($xmlObject, $selected, $extra, $field_status)
    {
        ...
        $data = array(
            ...
            'id' => $name,
            'placeholder' => $placeholder,
            'class' => 'form-control text-right ' . $extra
        );
    ...
    static function render_lookup($xmlObject, $selected, $extra, $field_status)
    {
        ...
        if (isset($xmlObject['dropdown_placeholder']) && $xmlObject['dropdown_placeholder'] == 0){
            ...
            $allTables["branches"] = "branch";
            $allTables["customers"] = "customer";
            $allTables["suppliers"] = "supplier";
            $allTables["contact_customers"] = "customer_contact";
            $allTables["contact_suppliers"] = "contact_suppliers";
            $allTables["currencies"] = "currency";
            $allTables["location_suppliers"] = "supplier_location";
            $allTables["location_customers"] = "customer_location";

            $options[" "] = dashboard_lang('_SELECT_'.strtoupper( $allTables[$ref_table] ));
        }
    ...
    static function render_image($xmlObject, $selected, $extra, $field_status)
    {
        ...
        $output_html .= boo2_render_image($selected, $img_upload_path, $sub_directory, $name, $field_status, $ajaxSavingClass, $width, $height );
        $data = array(
            'name' => $name,
            'id' => $name,
            'class' => $extra
